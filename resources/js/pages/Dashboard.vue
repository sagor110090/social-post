                ...
                <Card v-if="analytics_summary.posts_with_analytics > 0">
                    <div class="mb-6">
                        ...
                        <p
                            class="text-body text-neutral-600 dark:text-neutral-400"
                        >
                            Performance metrics across all platforms (Last 30
                            days)
                        </p>
                    </div>
                    ...
                    >
                        <div
                            class="rounded-xl border border-pink-200 bg-gradient-to-br from-pink-50 to-rose-50 p-4 text-center dark:border-pink-800 dark:from-pink-900/20 dark:to-rose-900/20"
                        >
                            <div
                                class="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-lg bg-pink-500 text-white"
                            >
                                <Heart class="h-4 w-4" />
                            </div>
                            <div
                        ...
                        <div
                            class="rounded-xl border border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 p-4 text-center dark:border-blue-800 dark:from-blue-900/20 dark:to-cyan-900/20"
                        >
                            <div
                                class="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-lg bg-blue-500 text-white"
                            >
                                <svg
                                    class="h-4 w-4"
                                    fill="none"
                        ...
                        <div
                            class="rounded-xl border border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 p-4 text-center dark:border-green-800 dark:from-green-900/20 dark:to-emerald-900/20"
                        >
                            <div
                                class="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-lg bg-green-500 text-white"
                            >
                                <svg
                                    class="h-4 w-4"
                                    fill="none"
                        ...
                        <div
                            class="rounded-xl border border-purple-200 bg-gradient-to-br from-purple-50 to-indigo-50 p-4 text-center dark:border-purple-800 dark:from-purple-900/20 dark:to-indigo-900/20"
                        >
                            <div
                                class="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-lg bg-purple-500 text-white"
                            >
                                <Eye class="h-4 w-4" />
                            </div>
                            <div
                        ...
                        <div
                            class="rounded-xl border border-orange-200 bg-gradient-to-br from-orange-50 to-amber-50 p-4 text-center dark:border-orange-800 dark:from-orange-900/20 dark:to-amber-900/20"
                        >
                            <div
                                class="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-lg bg-orange-500 text-white"
                            >
