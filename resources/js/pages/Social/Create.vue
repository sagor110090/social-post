        ...
        <div class="py-8">
            <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
                ...
                <div class="mb-8 text-center">
                    ...
                    >
                        Create
                        <span class="text-gradient">Amazing Content</span> ✨
                    </h1>
                    <p
                        class="text-body-large mx-auto max-w-2xl text-neutral-600 dark:text-neutral-400"
                    >
                        Craft compelling posts and publish them across all your
                        connected social media platforms with ease.
                    </p>
                </div>
                ...
                <div
                    v-if="flash?.success"
                    class="mb-6 flex items-center gap-3 rounded-xl border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20"
                >
                    <div
                    ...
                    <p class="text-body text-green-800 dark:text-green-200">
                        {{ flash.success }}
                    </p>
                </div>
                ...
                <div
                    v-if="flash?.error"
                    class="mb-6 flex items-center gap-3 rounded-xl border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-900/20"
                >
                    <div
                        class="flex h-8 w-8 items-center justify-center rounded-lg bg-red-500"
                    >
                        <AlertCircleIcon class="h-4 w-4 text-white" />
                    </div>
                    <p class="text-body text-red-800 dark:text-red-200">
                        {{ flash.error }}
                    </p>
                </div>
                ...
                <div class="grid gap-8 lg:grid-cols-3">
                        ...
                        >
                            <div class="mb-6">
                                ...
                                <p
                                    class="text-body text-neutral-600 dark:text-neutral-400"
                                >
                                    Add images, videos, or links to make your
                                    post more engaging (optional).
                                </p>
                            </div>
                            ...
                            <div class="mb-6 flex items-start justify-between">
                                <div>
                                    ...
                                    <p
                                        class="text-body text-neutral-600 dark:text-neutral-400"
                                    >
                                        Schedule your post to be published at
                                        the perfect time for maximum engagement.
                                    </p>
                                </div>
                    ...
                    <div class="space-y-8">
                        ...
                        >
                            ...
                            <div class="space-y-3">
                                <div
                                    v-for="(limit, platform) in characterLimits"
                                    :key="platform"
                        ...
                        >
                            ...
                            <div
                                v-if="!canPublish && form.content.length > 0"
