...
import { BrainCircuit, Copy, Edit, Lightbulb, RefreshCw, Wand2, AlertCircle } from 'lucide-vue-next';
...
const currentCharacterLimit = computed(() => {
    return characterLimits[form.value.platform as keyof typeof characterLimits] || 80000;
});
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="mb-12 animate-fade-in">
                    ...
                    <p class="text-body-large max-w-3xl text-neutral-600 dark:text-neutral-400 leading-relaxed">
                        Transform your ideas into compelling social media content with the power of artificial intelligence. Create engaging posts in seconds, not hours.
                    </p>
                    ...
                    <div
                        v-if="showTemplates"
                        class="card-elevated relative overflow-hidden mb-12 animate-slide-up"
                    >
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-500 via-orange-500 to-pink-500"></div>
                        <div class="mb-6">
                            <h2 class="text-headline-1 mb-3 text-neutral-900 dark:text-white flex items-center gap-4">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            >
                                <div class="mb-6 flex items-start justify-between">
                                    <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-100 to-pink-100 transition-all group-hover:scale-110 group-hover:rotate-3 shadow-md dark:from-purple-900/30 dark:to-pink-900/30">
                                        <Lightbulb class="h-7 w-7 text-purple-600 dark:text-purple-400" />
                                    </div>
                                    <Badge variant="secondary" class="text-xs font-semibold px-3 py-1">
                                        {{ template.category }}
                                    </Badge>
                                </div>
                                <h3 class="text-headline-3 group-hover:text-brand-primary mb-3 text-neutral-900 transition-colors dark:text-white">
                                    {{ template.name }}
                                </h3>
                                <p class="text-body-large mb-6 line-clamp-3 text-neutral-600 dark:text-neutral-400 leading-relaxed">
                                    {{ template.prompt }}
                                </p>
                    ...
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                        <!-- Input Form -->
                        <div class="card-elevated relative overflow-hidden group hover:scale-[1.01] transition-all duration-300">
                            ...
                            <div class="mb-6">
                                ...
                                <p class="text-body-large text-neutral-600 dark:text-neutral-400">
                                    Describe what you want to post about and customize the settings
                                </p>
                            </div>
                            ...
                            <div class="space-y-6">
                                <!-- Platform Selection -->
                                <div class="space-y-3">
                                    <label class="text-body-large flex items-center gap-3 font-semibold text-neutral-700 dark:text-neutral-300">
                                        Target Platform
                                    </label>
                                        ...
                                        <SelectContent>
                                            ...
                                            >
                                                <span class="flex items-center gap-4 py-2">
                                                    ...
                                                    <div>
                                                        <div class="font-semibold text-base">{{ platform.label }}</div>
                                                        <div class="text-sm text-neutral-500 dark:text-neutral-400">
                                                            {{ characterLimits[platform.value].toLocaleString() }} chars
                                                        </div>
                                                    </div>
                                                </span>
                                            </SelectItem>
                                    ...
                                    <div class="flex items-center gap-3 rounded-2xl border border-blue-200/60 bg-blue-50/80 p-4 backdrop-blur-sm dark:border-blue-800/60 dark:bg-blue-900/30">
                                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-500">
                                            <svg class="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                        </div>
                                        <p class="text-body font-medium text-blue-700 dark:text-blue-300">
                                            Character limit: {{ currentCharacterLimit.toLocaleString() }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <!-- Tone Selection -->
                                <div class="space-y-3">
                                    <label class="text-body flex items-center gap-2 font-medium text-neutral-700 dark:text-neutral-300">
                                        Content Tone
                                    </label>
                                            ...
                                            >
                                                <div class="flex items-center gap-3 py-2">
                                                    <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-neutral-100 dark:bg-neutral-800">
                                                        <span class="text-sm">{{ getToneEmoji(tone.value) }}</span>
                                                    </div>
                                                    <div>
                                                        <div class="font-medium">{{ tone.label }}</div>
                                                        <div class="text-xs text-neutral-500 dark:text-neutral-400">{{ tone.description }}</div>
                                                    </div>
                                                </div>
                                            </SelectItem>
                                        </SelectContent>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <span class="text-body-small text-neutral-600 dark:text-neutral-400">
                                        ...
                                        >
                                            <Lightbulb class="h-3 w-3 text-purple-600 dark:text-purple-400" />
                                            <span class="text-body-small font-medium text-purple-700 dark:text-purple-300">
                                ...
                                <!-- Options -->
                                <div class="space-y-4">
                                    <label class="text-body font-medium text-neutral-700 dark:text-neutral-300">Additional Options</label>
                                    <div class="space-y-3">
                                        <label class="flex cursor-pointer items-center gap-3 rounded-lg border border-neutral-200 p-3 transition-colors hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-800">
                                            <input
                                                type="checkbox"
                                            ...
                                            />
                                            <div class="flex-1">
                                                <span class="text-body font-medium text-neutral-900 dark:text-white">Include hashtags</span>
                                        ...
                                        <label class="flex cursor-pointer items-center gap-3 rounded-lg border border-neutral-200 p-3 transition-colors hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-800">
                                            ...
                                            />
                                            <div class="flex-1">
                                                <span class="text-body font-medium text-neutral-900 dark:text-white">Generate image ideas</span>
                                                <p class="text-body-small text-neutral-600 dark:text-neutral-400">
                                ...
                                <div class="flex gap-3">
                                    <Button
                                        ...
                                        class="btn-primary flex-1 py-3 hover-glow"
                                    >
                        ...
                        <div class="card-elevated relative overflow-hidden group hover:scale-[1.01] transition-all duration-300">
                            ...
                            <div class="space-y-6">
                                <div v-if="!generatedContent" class="py-16 text-center">
                                    <div class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30">
                                        <Wand2 class="h-8 w-8 text-purple-600 dark:text-purple-400" />
                                    </div>
                                    <h3 class="text-headline-4 mb-2 text-neutral-900 dark:text-white">
                                        Ready to create magic?
                                    </h3>
                                    <p class="text-body text-neutral-600 dark:text-neutral-400">
                                        Your AI-generated content will appear here once you describe what you want to post about.
                                    </p>
                                </div>
                                ...
                                <div v-else class="space-y-6">
                                    ...
                                    >
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div>
                                                <h4 class="text-body mb-1 font-medium text-red-800 dark:text-red-200">
                                                    Generation Error
                                                </h4>
                                                <p class="text-body-small text-red-700 dark:text-red-300">
                                    ...
                                    <!-- Content -->
                                    <div class="rounded-xl border border-neutral-200 bg-gradient-to-br from-neutral-50 to-neutral-100 p-6 dark:border-neutral-700 dark:from-neutral-800 dark:to-neutral-900">
                                        <div class="mb-4 flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                                <div class="bg-brand-primary flex h-8 w-8 items-center justify-center rounded-lg">
                                                    <Edit class="h-4 w-4 text-white" />
                                                </div>
                                                <h3 class="text-headline-4 text-neutral-900 dark:text-white">
                                                    Generated Content
                                                </h3>
                                            </div>
                                            <div class="flex items-center gap-3">
                                                <div class="text-right">
                                                    <span
                                                        ...
                                                        :class="isOverLimit ? 'text-red-600 dark:text-red-400' : 'text-neutral-600 dark:text-neutral-400'"
                                                    >
                                                        {{ contentLength }} / {{ currentCharacterLimit.toLocaleString() }}
                                                    </span>
                                                    <div v-if="!isOverLimit" class="text-body-small text-green-600 dark:text-green-400">
                                                        Perfect length ✅
                                                    </div>
                                                </div>
                                                <Button
                                        ...
                                        <div class="rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-700 dark:bg-neutral-800">
                                            <p class="text-body whitespace-pre-wrap text-neutral-700 dark:text-neutral-300">
                                    ...
                                    >
                                        ...
                                        <div class="rounded-lg border border-green-200 bg-white p-4 dark:border-green-700 dark:bg-neutral-800">
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        >
                                            ...
                                            <span class="font-medium">Use This Content</span>
                                        </Button>
                                        <Button
                                            variant="outline"
