        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="#" class="text-gray-400 hover:text-gray-400 transition-colors duration-200">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('about') }}" class="text-gray-300 hover:text-white transition-colors duration-200">
                            About Us
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('features') }}" class="text-gray-300 hover:text-white transition-colors duration-200">
                            Features
                        </a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('privacy-policy') }}" class="text-gray-300 hover:text-white transition-colors duration-200">
                            Privacy Policy
                        </a>
                    </li>
                    <li>
